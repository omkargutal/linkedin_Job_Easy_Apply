...
search_terms = ["Data Analyst", "Analyst", "Power BI Developer", "Data Engineer", "Data Consultant"]
...
location = ["India"]                      # (dynamic multiple select)
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp","Java", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
